...
$display_form = True;
$display_warning = "";
if (!empty($_POST['city']) && !empty($_POST['month']) && !empty($_POST['year']) && isset($_POST['weather'])) {
    ...
    foreach ($experienced_weather as $value) {
...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Homework23_02-Weather</title>
    </head>
